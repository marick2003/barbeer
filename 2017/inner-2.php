...
<body id="news">
	...
	<script>
		clickforce_rtid("8270001");
		ElandTracker.Track({'source':'CAP8270',
		'trackType':'view',
					...
					<div id="detail" class="box">
						...
						<div class="box-content">
							...
							<div class="links">
								...
								?>
								<a class="prev" href="https://www.kirin.com.tw/barbeer/CSV/2017/inner-<?=$prevId?>.php">上一篇：<?=$data[$prevId]['title']?></a>
								<a class="next" href="https://www.kirin.com.tw/barbeer/CSV/2017/inner-<?=$nextId?>.php">下一篇：<?=$data[$nextId]['title']?></a>
							</div>
							<div class="rule">
								<div class="rule-info">
								...
								<div class="rule-step">
									<div class="title">簡單<span class="font-30px">3</span>步驟 完成抽獎資格</div>
									<div class="item">
										<div class="title"><span class="font-18px black">Step1.</span> 按BarBEER粉絲團讚</div>
										<div class="fb-like" data-href="https://www.facebook.com/kirinbar/" data-width="456" data-layout="standard" data-action="like" data-size="small" data-show-faces="true" data-share="false"></div>
									</div>
									<div class="item">
									...
									<div class="item">
										...
										<div class="fb-comments" data-href="https://www.kirin.com.tw/barbeer/CSV/2017/inner-2.php" data-numposts="5"></div>
									</div>
								</div>
							</div>
